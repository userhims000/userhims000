...
class OfferCollection extends PostCollection {

    protected static $postType = 'offer';

    protected static $postClass = 'Rokit\Controllers\Types\Offer';
    ...
    public function action_list(){
        if( ! $this->_action_list ) {
            ...
            $action_list = $academy = $last_minutes = [];
            ...
            if (!empty($list_data)){
                ...
                if (!empty($academy_items) && !empty($list_data['academy'])) {
