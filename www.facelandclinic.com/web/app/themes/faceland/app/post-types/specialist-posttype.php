...
$labels = array(
	'name'               => _x( 'Specialists', 'post type general name', 'faceland' ),
	'singular_name'      => _x( 'Specialist', 'post type singular name', 'faceland' ),
	'menu_name'          => _x( 'Specialists', 'admin menu', 'faceland' ),
	'name_admin_bar'     => _x( 'Specialists', 'add new on admin bar', 'faceland' ),
    ...
    'all_items'          => __( 'All Specialists', 'faceland' ),
