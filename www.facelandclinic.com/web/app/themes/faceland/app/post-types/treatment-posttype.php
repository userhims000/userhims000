...
$labels = array(
	'name'               => _x( 'Treatment', 'post type general name', 'faceland' ),
	'singular_name'      => _x( 'Treatment', 'post type singular name', 'faceland' ),
	'menu_name'          => _x( 'Treatments', 'admin menu', 'faceland' ),
	'name_admin_bar'     => _x( 'Treatments', 'add new on admin bar', 'faceland' ),
    ...
    'all_items'          => __( 'All treatments', 'faceland' ),
...
rokit_register_posttype( 'treatment', array(
	...
	'rewrite' => array(
		'permastruct' => '%treatment_slug%/%treatment_type%/%treatment%'
	),
