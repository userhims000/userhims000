...
$labels = array(
	'name'               => _x( 'Action', 'post type general name', 'faceland' ),
	'singular_name'      => _x( 'Action', 'post type singular name', 'faceland' ),
	'menu_name'          => _x( 'Actions', 'admin menu', 'faceland' ),
	'name_admin_bar'     => _x( 'Actions', 'add new on admin bar', 'faceland' ),
    ...
    'all_items'          => __( 'All Actions', 'faceland' ),
...
rokit_register_posttype( 'offer', array(
