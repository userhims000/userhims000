...
$labels = array(
	'name'               => _x( 'Locations', 'post type general name', 'faceland' ),
	'singular_name'      => _x( 'Location', 'post type singular name', 'faceland' ),
	'menu_name'          => _x( 'Locations', 'admin menu', 'faceland' ),
	'name_admin_bar'     => _x( 'Locations', 'add new on admin bar', 'faceland' ),
    ...
    'all_items'          => __( 'All Locations', 'faceland' ),
...
rokit_register_posttype( 'location', array(

	// Add some default labels
	// When no labels are added labels will be generated in ENG
	'labels'        => $labels,
    'has_archive' => 'over-ons/klinieken',
    'menu_icon'     => 'dashicons-admin-multisite',
	'rewrite' => array(
		'permastruct' => '%location_slug%/%location_country%/%location%',
	),
