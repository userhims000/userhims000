...
$labels = array(
	'name'               => _x( 'Brands', 'post type general name', 'faceland' ),
	'singular_name'      => _x( 'Brand', 'post type singular name', 'faceland' ),
	'menu_name'          => _x( 'Brands', 'admin menu', 'faceland' ),
	'name_admin_bar'     => _x( 'Brands', 'add new on admin bar', 'faceland' ),
    ...
    'all_items'          => __( 'All brands', 'faceland' ),
...
rokit_register_posttype( 'brand', array(
