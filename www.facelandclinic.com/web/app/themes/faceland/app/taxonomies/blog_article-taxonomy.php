...
rokit_register_taxonomy( 'blog_article_taxonomy', 'blog_article', array(
...
function blog_article_taxonomy_link_filter( $url, $term, $taxonomy ) {

    if($taxonomy == 'blog_article_taxonomy') {
...
add_filter('term_link', 'blog_article_taxonomy_link_filter', 10, 3);
