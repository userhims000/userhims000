...
rokit_register_taxonomy( 'price_type', 'price', array(
...
function price_taxonomy_link_filter( $url, $term, $taxonomy ) {

    if($taxonomy == 'price_type') {
		$post_type_object = get_post_type_object('price');
...
add_filter('term_link', 'price_taxonomy_link_filter', 10, 3);
