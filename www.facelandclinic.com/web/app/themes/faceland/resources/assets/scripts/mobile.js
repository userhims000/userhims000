...
jQuery(document).ready(function($) {
    ...
    var $list = $(".treatment-price-list .c-list li.christmas-price-list-m");
    var batchSize = 4;
...
var documentReady = function documentReady() {
    ...
    const swiper = new Swiper('.mySwiper', {
      ...
      freeMode: true,
      autoplay: {
        delay: 1, // Slide transition delay (in milliseconds)
      ...
      breakpoints: {
        568: {
          slidesPerView: 3, // Show 2 slides on screens smaller than 768px
        },
        769: {
          slidesPerView: 4, // Show 2 slides on screens smaller than 768px
        },
        1024: {
          slidesPerView: 5, // Show 2 slides on screens smaller than 768px
        }           
      },
    });
