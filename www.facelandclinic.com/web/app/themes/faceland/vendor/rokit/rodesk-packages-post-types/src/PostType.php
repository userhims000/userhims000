...
class PostType {
    ...
    public function __construct( $post_type, array $args = array(), array $names = array() ) {
         ...
         */
        $args  = apply_filters( "rokit/posttypes/{$post_type}/args", $args );
        ...
        $names = apply_filters( "rokit/posttypes/{$post_type}/names", $names );
