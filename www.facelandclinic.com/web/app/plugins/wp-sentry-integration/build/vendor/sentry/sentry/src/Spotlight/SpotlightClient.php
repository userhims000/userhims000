...
{
    public static function sendRequest(\Sentry\HttpClient\Request $request, string $url) : \Sentry\HttpClient\Response
    {
        ...
        \curl_close($curlHandle);
        return new \Sentry\HttpClient\Response($statusCode, [], '');
    }
}
