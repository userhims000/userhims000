 ...
 * @internal
 */
class EventItem implements \Sentry\Serializer\EnvelopItems\EnvelopeItemInterface
{
     ...
     * }
     */
    protected static function serializeException(\Sentry\ExceptionDataBag $exception) : array
    {
