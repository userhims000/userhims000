 ...
 */
class Hub implements \Sentry\State\HubInterface
{
    /**
    ...
    public function captureCheckIn(string $slug, \Sentry\CheckInStatus $status, $duration = null, ?\Sentry\MonitorConfig $monitorConfig = null, ?string $checkInId = null) : ?string
    {
        ...
        $event = \Sentry\Event::createCheckIn();
        $checkIn = new \Sentry\CheckIn($slug, $status, $checkInId, $options->getRelease(), $options->getEnvironment(), $duration, $monitorConfig);
