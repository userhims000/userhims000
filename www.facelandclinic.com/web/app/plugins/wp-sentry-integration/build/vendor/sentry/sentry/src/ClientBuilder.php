...
final class ClientBuilder
{
    ...
    public function __construct(?\Sentry\Options $options = null)
    {
        ...
        $this->httpClient = $this->options->getHttpClient() ?? new \Sentry\HttpClient\HttpClient($this->sdkIdentifier, $this->sdkVersion);
        $this->transport = $this->options->getTransport() ?? new \Sentry\Transport\HttpTransport($this->options, $this->httpClient, new \Sentry\Serializer\PayloadSerializer($this->options), $this->logger);
    }
    /**
    ...
    {
        return new \Sentry\Client($this->options, $this->transport, $this->sdkIdentifier, $this->sdkVersion, $this->representationSerializer, $this->logger);
    }
}
