...
final class MonitorConfig
{
     ...
     */
    private $timezone;
    public function __construct(\Sentry\MonitorSchedule $schedule, ?int $checkinMargin = null, ?int $maxRuntime = null, ?string $timezone = null)
    {
    ...
    public function getSchedule() : \Sentry\MonitorSchedule
    {
        return $this->schedule;
    }
    public function setSchedule(\Sentry\MonitorSchedule $schedule) : self
    {
        $this->schedule = $schedule;
        return $this;
    }
