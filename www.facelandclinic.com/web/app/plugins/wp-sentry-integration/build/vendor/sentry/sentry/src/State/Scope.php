...
class Scope
{
    ...
    public function __construct(?\Sentry\Tracing\PropagationContext $propagationContext = null)
    {
        $this->propagationContext = $propagationContext ?? \Sentry\Tracing\PropagationContext::fromDefaults();
    }
    /**
     ...
     */
    public function applyToEvent(\Sentry\Event $event, ?\Sentry\EventHint $hint = null, ?\Sentry\Options $options = null) : ?\Sentry\Event
    {
        ...
        if ($this->span !== null) {
            ...
            if ($dynamicSamplingContext === null && $options !== null) {
                $dynamicSamplingContext = \Sentry\Tracing\DynamicSamplingContext::fromOptions($options, $this);
            }
    ...
    public function getPropagationContext() : \Sentry\Tracing\PropagationContext
    {
        return $this->propagationContext;
    }
    public function setPropagationContext(\Sentry\Tracing\PropagationContext $propagationContext) : self
    {
