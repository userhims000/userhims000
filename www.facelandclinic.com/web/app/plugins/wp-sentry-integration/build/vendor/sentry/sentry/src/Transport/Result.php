...
class Result
{
     ...
     */
    private $event;
    public function __construct(\Sentry\Transport\ResultStatus $status, ?\Sentry\Event $event = null)
    {
        $this->status = $status;
        $this->event = $event;
    }
     ...
     */
    public function getStatus() : \Sentry\Transport\ResultStatus
    {
        return $this->status;
    }
    /**
     ...
     */
    public function getEvent() : ?\Sentry\Event
    {
        return $this->event;
    }
}
