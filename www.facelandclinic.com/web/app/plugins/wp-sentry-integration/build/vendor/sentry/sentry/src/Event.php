...
final class Event
{
     ...
     */
    public function setUser(?\Sentry\UserDataBag $user) : self
    {
        $this->user = $user;
        return $this;
    }
     ...
     */
    public function setOsContext(?\Sentry\Context\OsContext $osContext) : self
    {
     ...
     */
    public function setRuntimeContext(?\Sentry\Context\RuntimeContext $runtimeContext) : self
    {
     ...
     */
    public function setStacktrace(?\Sentry\Stacktrace $stacktrace) : self
    {
    ...
    public function setProfile(?\Sentry\Profiling\Profile $profile) : self
    {
