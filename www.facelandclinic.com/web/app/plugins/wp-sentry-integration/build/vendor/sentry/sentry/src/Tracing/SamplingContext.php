...
final class SamplingContext
{
     ...
     */
    public static function getDefault(\Sentry\Tracing\TransactionContext $transactionContext) : self
    {
        $context = new self();
    ...
    public function getTransactionContext() : ?\Sentry\Tracing\TransactionContext
    {
