 ...
 * @param int   $alternative The index of the alternative seen by the visitor that resulted in a conversion.
 * @param array $options     Optional. Array that may include `value` and `unique_id`.
 *
 * @since 5.0.0
 * @since 5.1.0 Add `$value` param.
 * @since 6.0.4 Change `$value` param for `$options`.
 */
