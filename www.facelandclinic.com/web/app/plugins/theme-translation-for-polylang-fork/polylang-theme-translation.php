<?php
/* Plugin Name: Theme and plugin translation for Polylang (TTfP)(Rodesk Fork)
    ...
    public function run_theme_scanner()
    {
        ...
        foreach ($themes as $name => $theme) {
            if (!isset($settings['themes']) || in_array($name, $settings['themes'])) {
                ...
                $theme_path = apply_filters('rokit/ttfp/theme_path', $theme_path) ? apply_filters('rokit/ttfp/theme_path', $theme_path) : $theme_path;
