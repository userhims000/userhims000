 ...
 */
class ServerRequest extends \PYS_PRO_GLOBAL\GuzzleHttp\Psr7\Request implements \PYS_PRO_GLOBAL\Psr\Http\Message\ServerRequestInterface
{
    /**
     * @var array
     */
    ...
    public static function normalizeFiles(array $files)
    {
        ...
        foreach ($files as $key => $value) {
            if ($value instanceof \PYS_PRO_GLOBAL\Psr\Http\Message\UploadedFileInterface) {
    ...
    private static function createUploadedFileFromSpec(array $value)
    {
        ...
        return new \PYS_PRO_GLOBAL\GuzzleHttp\Psr7\UploadedFile($value['tmp_name'], (int) $value['size'], (int) $value['error'], $value['name'], $value['type']);
    }
    /**
