...
class UploadedFile implements \PYS_PRO_GLOBAL\Psr\Http\Message\UploadedFileInterface
{
    ...
    private function setStreamOrFile($streamOrFile)
    {
        if (\is_string($streamOrFile)) {
            ...
            $this->stream = new \PYS_PRO_GLOBAL\GuzzleHttp\Psr7\Stream($streamOrFile);
        } elseif ($streamOrFile instanceof \PYS_PRO_GLOBAL\Psr\Http\Message\StreamInterface) {
    ...
    public function getStream()
    {
        ...
        return new \PYS_PRO_GLOBAL\GuzzleHttp\Psr7\LazyOpenStream($this->file, 'r+');
    }
    /**
     * {@inheritdoc}
     *
