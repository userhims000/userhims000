        ...
        switch (\gettype($resource)) {
            ...
            case 'object':
                if ($resource instanceof \PYS_PRO_GLOBAL\Psr\Http\Message\StreamInterface) {
                    ...
                    return new \PYS_PRO_GLOBAL\GuzzleHttp\Psr7\PumpStream(function () use($resource) {
                        if (!$resource->valid()) {
                            return \false;
                        }
                    ...
                    return \PYS_PRO_GLOBAL\GuzzleHttp\Psr7\Utils::streamFor((string) $resource, $options);
                }
                break;
            case 'NULL':
