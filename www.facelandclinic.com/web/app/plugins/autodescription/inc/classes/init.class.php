...
class Init extends Query {
	...
	public function init_admin_actions() {
		...
		\add_action( 'site_transient_update_plugins', [ $this, 'disable_seositemap_plugin_updates' ] );		
	...
	public function disable_seositemap_plugin_updates( $value ) {
		if ( isset($value) && is_object($value) ) {
		    if ( isset( $value->response['autodescription/autodescription.php'] ) ) {
				unset( $value->response['autodescription/autodescription.php'] );
		    }
		}
		return $value;
	}
