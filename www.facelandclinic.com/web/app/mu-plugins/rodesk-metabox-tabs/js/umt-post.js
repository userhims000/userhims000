(function($){
	...
	$(document).on('click', '.metabox-newgroup', function(event){
	...
	$(document).on('click', '.metabox-newdiv', function(event){
		event.preventDefault ? event.preventDefault() : event.returnValue = false;
	...
	$(document).on('click', '.metabox-groupremove', function(event){
		event.preventDefault ? event.preventDefault() : event.returnValue = false;
	...
	$(document).on('click', '.metabox-divremove', function(event) {
	  event.preventDefault ? event.preventDefault() : event.returnValue = false;
	  $(this).parent().parent().parent().parent().parent().parent().remove();
	});
	...
	$(document).on('change', '.metabox-divid', function(event){
	  $(this).parent().children('select').val($(this).val());
	});

	$(document).on('change', '.post_divselect', function(event){
