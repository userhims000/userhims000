...
if (function_exists('wpthumb_add_crop_from_position_admin_hooks')) {
 ...
 * @return $post
 */
if (function_exists('wpthumb_media_form_crop_position')) {
 ...
 * @return $post
 */
if (function_exists('wpthumb_media_form_crop_position_save')) {
